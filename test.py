...
class Searches:
    ...
    def manually_enter_text(self, searchbar, term: str, min_delay: float = 0.4, max_delay: float = 0.9):
        for char in term:
    ...
    def bingSearch(self, searchRelatedTerms: bool = False, relatedTermsCount: int = 0, searchCount: int = 0) -> int:
        ...
        for _ in range(3):
            ...
            self.manually_enter_text(searchbar, term, min_delay=0.4, max_delay=0.9)  # Use the manual typing function
        ...
        if searchRelatedTerms:
            ...
            for i, related_term in enumerate(uniqueTerms):
                ...
                try:
                    ...
                    self.manually_enter_text(searchbar, related_term, min_delay=0.4, max_delay=0.9)  # Use the manual typing function
                    searchbar.submit()
                    searchCount += 1
